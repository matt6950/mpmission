...
_servicePointClasses = ["Land_A_FuelStation_Feed", "FuelPump_DZ", "Land_A_FuelStation_Feed", "Land_Ind_TankSmall", "Land_Ind_TankSmall2", "Land_Ind_TankSmall2_EP1", "Land_fuel_tank_stairs"];
...
_refuel_updateInterval = 3; // update interval (in seconds)
...
_repair_costs = [
	["Air",["ItemGoldBar",7]], // 5 Gold for helicopters and planes
