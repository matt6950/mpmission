...
//walking dead zombies added by Automaticmb
     if (!isDedicated) then {
	...
	// Snap build stuff - added by DY357LX
	...
	// We don't need this as we're using snap_pro - added by DY357LX
	...
	// We don't need this as we're using snap_pro
